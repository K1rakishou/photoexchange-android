...
class TakenPhotoEntity(
    ...
    companion object {
        ...
        fun create(tempFileId: Long?, isPublic: Boolean): TakenPhotoEntity {
            return TakenPhotoEntity(null, tempFileId, isPublic, null, 0.0, 0.0, PhotoState.PHOTO_TAKEN, TimeUtils.getTimeFast())
        }
