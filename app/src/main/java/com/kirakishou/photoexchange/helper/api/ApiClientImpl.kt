...
import com.kirakishou.photoexchange.helper.api.request.GetPhotoNewLocationRequest
...
@Inject constructor(
    ...
    override fun getPhotoRecipientsLocations(userId: String, photoIds: String): Single<GetUserLocationResponse> {
