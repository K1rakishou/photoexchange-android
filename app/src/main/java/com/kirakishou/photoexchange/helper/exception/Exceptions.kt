...
class ImageLoadingDisabledInSettings : Exception("Current network is metered and it is disabled in the settings to load images from the internet with metered network. You can change this behavior in the settings.")
